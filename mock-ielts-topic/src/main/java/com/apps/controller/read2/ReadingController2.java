package com.apps.controller.read2;

import com.apps.common.ResponseResult;
import com.apps.dto.read2.ReadingDTO;
...
import com.apps.service.read2.ReadingService2;
...
@RestController
@RequestMapping("/topic/reading2")
public class ReadingController2 {

    @Autowired
    private ReadingService2 readingService2;
    ...
    public ResponseResult<Void> addReadingWithQuestionsAndAnswers(@RequestBody ReadingInsertDTO readingInsertDTO) {
        try {
            ...
            readingService2.insertReadingWithQuestions(readingInsertDTO);
    ...
    public ResponseResult<ReadingInsertDTO> getReadingWithQuestionsAndAnswers(@PathVariable Long id) {
        try {
            ...
            ReadingInsertDTO readingInsertDTO = readingService2.getReadingSummaryById(id);
...
public ResponseResult<List<ReadingSummary>> getAllReadingIDs() {
    try {
        // 调用服务层方法获取所有阅读汇总
        List<ReadingSummary> readingSummaries = readingService2.getAllReadingSummary();
    ...
    public ResponseResult<Void> deleteReadingAndQuestions(@PathVariable Long id) {
        try {
            ...
            readingService2.deleteReadingSummaryById(id);
